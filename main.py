...
def pixelCounter(first_piece, second_piece, third_piece):
    ...
    if max_index==0:
        ...
        forward=media.get_position()
        while(max_index==0 and forward!=0.9):
            forward=forward+0.1
            media.set_position(forward)
        ...
        rewind=media.get_position()
        while(max_index==2 and rewind!=0.1):
            rewind=rewind-0.1
            media.set_position(rewind)
